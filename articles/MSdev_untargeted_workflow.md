...
Tune peak picking and correspondence before processing (example values
from a recent lipidomics run):
...
- `Statistic/<type>/Figures.pdf` — volcano (unadjusted then adjusted) +
  heatmap
...
exploratory runs (`QC_RSD = Inf` disables QC-RSD filtering in the
example).
